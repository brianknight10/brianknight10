...
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.125.6](https://github.com/gohugoio/hugo/releases/tag/v0.125.6), 2 days ago) - The world’s fastest framework for building websites.
- [oven-sh/bun](https://github.com/oven-sh/bun) ([bun-v1.1.7](https://github.com/oven-sh/bun/releases/tag/bun-v1.1.7), 4 days ago) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
