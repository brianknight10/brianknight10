...
- [oven-sh/bun](https://github.com/oven-sh/bun) ([bun-v1.1.5](https://github.com/oven-sh/bun/releases/tag/bun-v1.1.5), 1 day ago) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.125.4](https://github.com/gohugoio/hugo/releases/tag/v0.125.4), 2 days ago) - The world’s fastest framework for building websites.
- [denoland/deno_std](https://github.com/denoland/deno_std) ([0.224.0](https://github.com/denoland/deno_std/releases/tag/0.224.0), 2 days ago) - The Deno Standard Library
