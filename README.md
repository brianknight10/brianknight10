...
- [oven-sh/bun](https://github.com/oven-sh/bun) ([bun-v1.0.16](https://github.com/oven-sh/bun/releases/tag/bun-v1.0.16), 1 day ago) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.121.1](https://github.com/gohugoio/hugo/releases/tag/v0.121.1), 3 days ago) - The world’s fastest framework for building websites.
- [denoland/fresh](https://github.com/denoland/fresh) ([1.6.1](https://github.com/denoland/fresh/releases/tag/1.6.1), 4 days ago) - The next-gen web framework.
