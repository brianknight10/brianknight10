...
- [oven-sh/bun](https://github.com/oven-sh/bun) ([bun-v1.1.7](https://github.com/oven-sh/bun/releases/tag/bun-v1.1.7), 1 day ago) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.125.5](https://github.com/gohugoio/hugo/releases/tag/v0.125.5), 3 days ago) - The world’s fastest framework for building websites.
